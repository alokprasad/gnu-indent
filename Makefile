...
pkgdatadir = $(datadir)/indent
pkgincludedir = $(includedir)/indent
pkglibdir = $(libdir)/indent
pkglibexecdir = $(libexecdir)/indent
...
#am__append_1 = -g -Wall -I.
am__append_2 = -I.
subdir = .
ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
am__aclocal_m4_deps = $(top_srcdir)/aclocal/UTIMBUF.m4 \
	$(top_srcdir)/m4/codeset.m4 $(top_srcdir)/m4/extern-inline.m4 \
...
ACLOCAL = ${SHELL} /opt/gnu-indent/config/missing aclocal-1.16
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /opt/gnu-indent/config/missing autoconf
AUTOHEADER = ${SHELL} /opt/gnu-indent/config/missing autoheader
AUTOMAKE = ${SHELL} /opt/gnu-indent/config/missing automake-1.16
AWK = gawk
...
CC_FOR_BUILD = $(CC)
CFLAGS = -g -O2 $(am__append_1) $(am__append_2)
...
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DVIPS = /opt/gnu-indent/config/missing dvips
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LTLIBTHREAD = 
MAINT = #
MAKEINFO = ${SHELL} /opt/gnu-indent/config/missing makeinfo
...
PACKAGE_URL = http://www.gnu.org/software/indent/
...
abs_builddir = /opt/gnu-indent
abs_srcdir = /opt/gnu-indent
abs_top_builddir = /opt/gnu-indent
abs_top_srcdir = /opt/gnu-indent
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /opt/gnu-indent/config/install-sh
...
MAINTAINERCLEANFILES = intl/* aclocal.m4 Makefile.in \
	...
	indent-1.spec \
	indent.lsm indent-2.spec .gdbinit \
	INSTALL ABOUT-NLS 
...
ps:
	cd doc && $(MAKE) indent.ps

pdf:
	cd doc && $(MAKE) indent.pdf
...
#indent.lsm :%: Makefile %.in
#	sed -e 's%!VERSION!%2.2.12%g' $@.in > $@
